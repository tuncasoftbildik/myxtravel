...
const PANELS = [
  ...
  {
    title: "Blog Yönetimi",
    description: "Blog yazıları ekle, düzenle, yayınla",
    href: "/admin/blog",
    permission: "blog",
    icon: "M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z",
    color: "bg-teal-500",
  ...
  },
  {
    ...
    description: "Admin ekle, yetkileri düzenle veya kaldır",
...
export default function AdminDashboard() {
  const { isAdmin, isLoggedIn, loading, role, permissions } = useAdmin();
      ...
      <main className="min-h-screen bg-[#f5f0e8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {PANELS.filter((panel) => {
              if (panel.permission === "_super_admin_only") return role === "super_admin";
              return hasPermission(permissions, panel.permission);
            }).map((panel) => (
              <Link
                key={panel.href}
                href={panel.href}
