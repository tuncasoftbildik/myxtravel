      ...
      <main className="flex-1 bg-gray-50">
        ...
        <div className="relative bg-gradient-to-br from-brand-dark via-[#2d1b69] to-[#0f172a] overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-10 pb-20 sm:pt-14 sm:pb-24 text-center">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-3">Araç Kiralama</h1>
            <p className="text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              Türkiye&apos;nin her yerinde uygun fiyatlı, güvenilir araç kiralama
            </p>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-12 sm:pt-16">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              {
                title: "Km Sınırı Yok",
                desc: "Sınırsız kilometre ile özgürce seyahat edin",
                icon: "M13 10V3L4 14h7v7l9-11h-7z",
                color: "#10b981",
              },
              {
                title: "Full Kasko Dahil",
                desc: "Tüm araçlarda kapsamlı kasko sigortası",
                icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
                color: "#6366f1",
              },
              {
                title: "Ücretsiz İptal",
                desc: "48 saat öncesine kadar ücretsiz iptal hakkı",
