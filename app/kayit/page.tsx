      ...
      <div className="min-h-screen flex items-center justify-center bg-white p-6">
        <div className="max-w-md text-center">
          ...
          <p className="text-gray-500 mb-6">
            <strong className="text-gray-700">{email}</strong> adresine doğrulama bağlantısı gönderdik. Lütfen e-postanızı kontrol edin.
          </p>
          <Link
            href="/giris"
            className="inline-block px-8 py-3 bg-brand-red text-white font-semibold rounded-2xl hover:bg-red-700 transition-all"
          >
            Giriş Yap
          </Link>
        </div>
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-[#1a0a2e] via-[#2d1b69] to-[#0f0520] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-white/60 text-lg leading-relaxed">
            Ücretsiz hesap oluştur, en iyi fiyatları keşfet ve hızlıca rezervasyon yap.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-500 mb-8">Ücretsiz hesabınızı oluşturun</p>
          ...
          <p className="text-center text-sm text-gray-500 mt-8">
            ...
            <Link href={`/giris${redirect !== "/" ? `?redirect=${encodeURIComponent(redirect)}` : ""}`} className="text-brand-red font-semibold hover:text-red-700 transition">
              Giriş Yap
            </Link>
          </p>
          ...
          <p className="text-center text-xs text-gray-400 mt-4">
            Kayıt olarak{" "}
            <Link href="/kullanim-sartlari" className="underline hover:text-gray-600">Kullanım Şartlarını</Link>
            {" "}ve{" "}
            <Link href="/gizlilik" className="underline hover:text-gray-600">Gizlilik Politikasını</Link>
