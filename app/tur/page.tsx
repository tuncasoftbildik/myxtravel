          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-8 pb-14 sm:pt-10 sm:pb-16">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
              <div>
                ...
                {loading ? (
                  <p className="text-sm text-white/50 mt-2">Turlar aranıyor...</p>
                ) : !error && (
    ...
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 overflow-hidden">
        <div className="flex items-center gap-3 mb-4">
          ...
          <p className="text-sm font-medium text-gray-600">Turlar yükleniyor...</p>
        </div>
      ...
      {[1, 2, 3].map((i) => (
        <div
          ...
          style={{ animation: `pulse 1.5s ease-in-out infinite`, animationDelay: `${i * 200}ms` }}
        >
          <div className="flex flex-col sm:flex-row">
            <div className="sm:w-56 h-44 sm:h-48 shimmer" />
